...
namespace SuperSocketServer.Commands.DoubBidDocTwo
{
    public class CoefCollectionReply : CommandBase<MySession, MyRequestInfo>, IPush
    {
        private const SuperSocketServer.Commands.BaseService.DoubBidDocTwo Action = SuperSocketServer.Commands.BaseService.DoubBidDocTwo.CoefCollectionReply;
