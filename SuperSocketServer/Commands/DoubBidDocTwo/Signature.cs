...
{
   public  class Signature : CommandBase<MySession, MyRequestInfo>,IPush
   {
       private const SuperSocketServer.Commands.BaseService.DoubBidDocTwo Action = SuperSocketServer.Commands.BaseService.DoubBidDocTwo.Signature;
