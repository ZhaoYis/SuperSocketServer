...
{
    public class CoefEndReply : CommandBase<MySession, MyRequestInfo>, IPush
    {
        private const SuperSocketServer.Commands.BaseService.DoubBidDocTwo Action = SuperSocketServer.Commands.BaseService.DoubBidDocTwo.Announce;
