...
{
  public   class DecSendTime : CommandBase<MySession, MyRequestInfo>, IPush
  {
      private const SuperSocketServer.Commands.BaseService.DoubBidDocOne Action = SuperSocketServer.Commands.BaseService.DoubBidDocOne.DecSendTime;
